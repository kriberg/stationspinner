    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currentTQTime', stationspinner.libs.fields.DateTimeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('typeID', models.IntegerField()),
                ('endTime', stationspinner.libs.fields.DateTimeField()),
                ('startTime', stationspinner.libs.fields.DateTimeField()),
        ...
        migrations.AddField(
            model_name='asset',
            name='parent',
            field=mptt.fields.TreeForeignKey(related_name=b'children', blank=True, to='character.Asset', null=True),
            preserve_default=True,
        ),
    ]
